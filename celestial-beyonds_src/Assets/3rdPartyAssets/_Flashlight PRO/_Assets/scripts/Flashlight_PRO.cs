...
{
    [Space(10)] [SerializeField()] GameObject Lights; // all light effects and spotlight
    ...
    public void Change_Intensivity(float percentage)
    {
        ...
        ambient_light_material.SetColor("_TintColor",
            new Color(ambient_mat_color.r, ambient_mat_color.g, ambient_mat_color.b, percentage / 2000));
    }
